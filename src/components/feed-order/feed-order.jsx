  ...
  >
    <div className={`${styles.feed__order}  `}>
      <div className={`${styles.feed__order__container}  `}>
        ...
        <p className={`${styles.time} text text_type_main-default`}>{props.time}</p>
      </div>
      ...
      <div className={`${styles.feed__order__container} ${ !isMobile ? "pt-6" : "pb-4"}`}>
        <div className={`${styles.images__container} ${isMobile && "pt-4"}`}>
          <div
          ...
          {props.items.length > 1 ? (
            <div
              style={{ left: `${ isMobile ? "25px" :" 50px"}`, zIndex: "6" }}
              className={`${styles.image__container} `}
            >
              <div className={`${styles.image__container__flex} `}>
                <div
          ...
          {props.items.length > 3 ? (
            <div
              style={{ left: `${ isMobile ? "75px" :" 150px"}`, zIndex: "4" }}
              className={`${styles.image__container} `}
            >
              <div className={`${styles.image__container__flex} `}>
                <div
          ...
          {props.items.length > 4 ? (
            <div
              style={{ left: `${ isMobile ? "100px" :" 200px"}`, zIndex: "3" }}
              className={`${styles.image__container} `}
            >
              <div className={`${styles.image__container__flex} `}>
                <div
          ...
          {props.items.length > 5 ? (
            <div
              style={{ left: `${ isMobile ? "125px" :" 250px"}`, zIndex: "2" }}
              className={`${styles.image__container} `}
            >
              <div className={`${styles.image__container__flex} `}>
                <div
                ...
                {props.items.length > 6 ? (
                  <div
                    className={`${styles.total} text ${isMobile ? "text_type_digits-small  pt-7" : "text_type_digits-default pt-15"} `}
                  >
                    +{props.items.length - 6}
                  </div>
                ) : null}
        ...
        <div className={`${styles.feed__order__container} pt-5 `}>
          <p className={` text text_type_digits-default pr-1`}>{props.price}</p>
          <CurrencyIcon />
        </div>
      </div>
    </div>
